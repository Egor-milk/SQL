...
/* 2. Добавить в таблицу после создания 
колонку middle_name varchar */
...
/* 7. Вставить три любых записи с 
автогенерацией идентификатора */

INSERT INTO exam (exam_name, exam_date)
VALUES
('math', '1990-01-01'),
('russian_language', '1990-01-02'),
('drawing', '1990-01-03');


/* 8. Посредством полной выборки убедиться, 
что данные были вставлены нормально и 
